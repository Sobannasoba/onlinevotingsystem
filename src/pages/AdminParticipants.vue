...
export default {
  ...
  methods: {
    ...
    async fetchParticipants() {
      try {
        const response = await axios.get('http://128.199.118.198/fyp/config/participants.php');
    ...
    submitForm() {
      // Implement your form submission logic here
        ...
        if (this.id ==""){
            var url = "http://128.199.118.198/fyp/config/insert_participant.php"
        }
        else{
            var url = "http://128.199.118.198/fyp/config/update_participant.php"
        }
    ...
    deletePopup(index){
        ...
        axios.post("http://128.199.118.198/fyp/config/delete_participant.php", formData)
        .then(response => {
            console.log(response.data);
            alert(response.data)
            if (response.status == 200){
